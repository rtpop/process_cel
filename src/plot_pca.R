...
option_list <- list(
    ...
    make_option(c("--top_n"), type="logical", default=FALSE, help="Whether to use top N variable genes for PCA [default %default]"),
    make_option(c("--n_probes"), type="integer", default=1000, help="Number of top variable genes to use if top_n is TRUE [default %default]")
)
